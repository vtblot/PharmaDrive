<table class="table table-striped table-hover ">
  ...
  <tbody>
    ...
    <tr class="lien info">
      	...
      	<td onclick="document.location='/ppe_pharmadrive_noob/patients/<?=$visite->getPatient()->getNom().'_'.$visite->getPatient()->getPrenom()?>'"><?=$visite->getPatient()->getNom().' '.$visite->getPatient()->getPrenom()?></td>
